...
try:
    ...
    print("OK: from impacket.smbconnection import SMBConnection")
except Exception as e:
    print(f"ERROR: from impacket.smbconnection import SMBConnection: {e}")
    import traceback
...
try:
    ...
    print("\nOK: apt_framework imported successfully")
    ...
    print(f"\nERROR: apt_framework import failed: {e}")
    import traceback
    print(traceback.format_exc())
